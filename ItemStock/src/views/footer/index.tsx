...
const Footer = ():JSX.Element => {
  ...
  <div className=" max-w-full px-4 bg-slate-200  ">
    <div className="flex flex-wrap text-left lg:text-left">
      <div className="w-full lg:w-6/12 px-4">
        <h4 className="text-3xl fonat-semibold text-blueGray-100 mt-10">Let's keep in touch!</h4>
        <h5 className="text-lg mt-0 mb-2 text-blueGray-200 font-thin">
