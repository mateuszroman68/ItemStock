...
<div className="mx-auto   w-5/12  bg-gray-800 border-b  rounded   overflow-hidden shadow-lg  text-white mt-8 mb-8">
  <div className="mx-auto w-full max-w-lg mt-4 mb-4 mr-2 ml-4">
    <h1 className="text-2xl font-medium  ">Contact us</h1>
    <p className="mt-3">Email us at help@stockitem.com or message us here:</p>
    ...
    <form action="https://api.web3forms.com/submit" className="mt-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <div className="relative z-0 col-span-2">
          <textarea name="message" className="grid grid-rows-5 peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" "></textarea>
      ...
      <button className="bg-neutral-200  border-b  rounded   px-12 py-4 text-l text-neutral-600 hover:text-grey-800 hover:shadow-[inset_13rem_0_0_0] hover:shadow-amber-200 duration-[400ms,700ms] transition-[color,box-shadow] rounded mt-8">
        Send a message
    </button>
    </form>
  </div>
