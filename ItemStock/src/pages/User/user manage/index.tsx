...
<div className="flex flex-1 m-2">
            <div className="mb-3 xl:w-96 flex flex-1  ">
            <label  className="form-label inline-block m-2 text-gray-50 w-2/4 " >Password</label >
            <input
            type="text"
            className="
                form-control
...
<div className="flex flex-1 m-2">
            <div className="mb-3 xl:w-96 flex flex-1  ">
            <label  className="form-label inline-block m-2 text-gray-50 w-2/4 " >Confirm password</label >
            <input
            type="text"
            className="
                form-control
